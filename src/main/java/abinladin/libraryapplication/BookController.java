...
public class BookController {
    ...
    private void buttonAddBook(){
       ...
       try {
            Connection con = DriverManager.getConnection("jdbc:mysql://localhost:3306/library", "root", "Abdullah@2511");
            Statement statement = con.createStatement();

            String query = String.format("insert into book values(\"%s\",\"%s\",\"%s\");", book.getTitle(), book.getAuthor(), book.getPublisher());
